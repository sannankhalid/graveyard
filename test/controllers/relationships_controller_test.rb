...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { is_active: @relationship.is_active, name: @relationship.name } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { is_active: @relationship.is_active, name: @relationship.name } }
